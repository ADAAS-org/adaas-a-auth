...
export declare class A_AUTH_ServerDelegate_APIProvider<C extends A_AUTH_ContextClass> extends A_AUTH_APIProvider<C> {
    protected request<T, M>(method: Method, url: string, auth: A_AUTH_TYPES__IAuthenticator, data?: any, params?: any, config?: A_SDK_TYPES__Required<A_AUTH_TYPES__APIProviderRequestConfig<M, A_AUTH_ServerDelegateAuthenticator>, ['authenticator']>): Promise<T>;
