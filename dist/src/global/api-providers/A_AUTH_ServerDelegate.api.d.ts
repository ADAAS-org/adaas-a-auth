...
export declare class A_AUTH_ServerDelegate_APIProvider extends A_AUTH_APIProvider {
    ...
    protected get<T, M = any>(url: string, config: A_SDK_TYPES__Required<A_AUTH_TYPES__APIProviderRequestConfig<M, A_AUTH_ServerDelegateAuthenticator>, ['authenticator']>): Promise<T>;
